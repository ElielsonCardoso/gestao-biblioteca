...
public class UsuarioResource {
    ...
    @GetMapping
    public Page<Usuario> findAll(@RequestParam(defaultValue = "0") int page,
    ...
    @PutMapping
    public ResponseEntity<Usuario> updateUsuario(@RequestBody Usuario usuarioAtualizado) throws Exception {
        return ResponseEntity.ok(service.updateUsuario(usuarioAtualizado));
    }
